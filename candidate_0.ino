...
DEFINE_GRADIENT_PALETTE( GoldColors_p ) {
  0,     0,  0,  0,   //black
//128,   255,255,  0,   //red
50,   255,215,  0,   //bright yellow
100,     0,  0,  0,   //black
150,   255,215,  0,   //bright yellow
200,     0,  0,  0,   //black
250,   255,215,  0,   //bright yellow
255,   255,255,255 }; //full white

DEFINE_GRADIENT_PALETTE( GoldColorsFlashing_p ) {
  0,     0,  0,  0,   //black
10,   255,215,  0,   //bright yellow
30,     0,  0,  0,   //black
50,   255,215,  0,   //bright yellow
70,     0,  0,  0,   //black
90,   255,215,  0,   //bright yellow
110,     0,  0,  0,   //black
130,   255,215,  0,   //bright yellow
150,     0,  0,  0,   //black
170,   255,215,  0,   //bright yellow
200,     0,  0,  0,   //black
220,   255,215,  0,   //bright yellow
240,     0,  0,  0,   //black
250,   255,215,  0,   //bright yellow
255,   255,255,255 }; //full white


DEFINE_GRADIENT_PALETTE( GreenColors_p ) {
  0,     0,  0,  0,   //black
50,      0,179,  0,   //bright green
100,     0,  0,  0,   //black
150,     0,179,  0,   //bright green
200,     0,  0,  0,   //black
250,     0,179,  0,   //bright green
255,   255,255,255 }; //full white

DEFINE_GRADIENT_PALETTE( GreenColorsFlashing_p ) {
 0,  0,  0,  0,   //black
10,  0,179,  0,   //bright green
30,  0,  0,  0,   //black
50,  0,179,  0,   //bright green
70,  0,  0,  0,   //black
90,  0,179,  0,   //bright green
110, 0,  0,  0,   //black
130, 0,179,  0,   //bright green
150, 0,  0,  0,   //black
170, 0,179,  0,   //bright green
200, 0,  0,  0,   //black
220, 0,179,  0,   //bright green
240, 0,  0,  0,   //black
250, 0,179,  0,   //bright green
255, 255,255,255 }; //full white
...
void loop()  {
 ...
 switch (ledMode) {
       ...
       case 1: currentPalette = GoldColors_p; rainbow(); break;
       case 2: currentPalette = GoldColorsFlashing_p; rainbow(); break;
       case 3: currentPalette = GreenColors_p; rainbow(); break;
       case 4: currentPalette = GreenColorsFlashing_p; rainbow(); break;
